<?php
	...
	$sql = "select count(*) from user where id='$uid'";
	...
	{
?>
	<br><div style='font-family:"malgun gothic"; color:red; margin-left:130px;'><?php echo $uid; ?>는 중복된 아이디입니다.</div>
  <script>window.opener.document.getElementById('chkid').value="0";</script>

<?php
	}else{
?>
  <br><div style='font-family:"malgun gothic"; margin-left:130px;'><?php echo $uid; ?>는 사용가능한 아이디입니다.</div>
  <script>window.opener.document.getElementById('chkid').value="1";</script>

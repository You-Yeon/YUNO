    ...
    <div id="jb-container">
      ...
      <div id="jb-content">
        ...
        ?>
                ...
                <div class="view_btn">
                  <button class="view_btn1" onclick="location.href='./free_community.php'">목록으로</button>
                </div>

                <table class="view_comment_input" align=center style="margin:10px;">
                <tr>
                    <td><textarea readonly id= "com_content" onclick= "no_input()" name = content cols=80 rows=4 style="width:750px; height:80px;" placeholder="댓글을 입력하세요."></textarea></td>
                    <td><input type="button" onclick= "no_input()" value="SEND" color="#FFF666" style="font-family:Dotspitch; text-decoration:none; text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -2px black; text-align:center; width:200px; height:80px; color:#FFF666; font-size:22pt; background-color: #07C830;"> </td>
                </tr>
                </table>

                <table align=center border="1" style="border-collapse:collapse; border:1px black; ">
                    ...
                    while($rows = mysqli_fetch_assoc($result)){ //DB에 저장된 데이터 수 (열 기준)
                      ...
                      <td width = "100" align = "center">
                        <?php if($rows['name'] == $user_name || $user_authority == 1 ) {?>
                          <!-- <button class="view_btn2" onclick="location.href='./free_community_mod.php?border_number=<?php echo $number?>'">수정</button> -->

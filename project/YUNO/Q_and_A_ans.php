...
<html lang="ko">
  ...
  <body>
    <?php
      ...
      if($user_authority == 0){
        echo "<script>alert('잘못된 접근입니다.'); location.href='./main_in.php'; </script>";
        exit;
      }
    ?>
    <div id="jb-container">
      ...
      <div id="jb-content">
        ...
        <?php
          ...
          $query = "select title, content, Lastdate, views, name from q_and_a where num =$number";
          $result = $connect->query($query);
          $total = mysqli_num_rows($result);
          $rows = mysqli_fetch_assoc($result);
        ?>

        <form method = "post" action = "Q_and_A_ans_action.php">
